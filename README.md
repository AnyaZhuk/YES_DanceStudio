...
**Презентация для заказчика (14 слайдов):**  
[`presentation/index.html`](presentation/index.html) — откройте в браузере, листайте стрелками ← → или кнопками внизу.
...
## Этапы работ и стоимость

| Этап | Содержание | Стоимость |
| --- | --- | --- |
| **1. Прототип главной** | Дизайн, вёрстка, SEO-основа, форма, мобильная версия | **[X] ₽** — выполнено |
| **2. Полный редизайн + запуск** | Внутренние страницы, интеграция формы, перенос на yesds.ru, тестирование | **[Y] ₽** |
| **3. Поддержка** *(опционально)* | Обновление афиш, расписания, мелкие правки | **[Z] ₽/мес** |

> Цифры **[X]**, **[Y]**, **[Z]** — заполните перед отправкой заказчику.

**Почему имеет смысл продолжить с тем же подрядчиком:**
- Результат уже виден — не «кот в мешке».
- Бренд, филиалы, SEO и форма уже проработаны — другому придётся начинать с нуля.
- Каждый месяц со старым сайтом — потерянные заявки с мобильного поиска.
